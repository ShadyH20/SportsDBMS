...
namespace SportsWeb
{
    public partial class SystemAdmin : System.Web.UI.Page
    {
        ...
        protected void addnewclub(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Fill Both Boxes With The Required Information');", true);
            }
            else
            {
                Login.conn.Open();
        ...
        protected void deleteclubbox(object sender, EventArgs e)
        {
            ...
            if (deleteclubB.Text == "")
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Fill The Boxes With The Required Information');", true);
            }
            else
            {
