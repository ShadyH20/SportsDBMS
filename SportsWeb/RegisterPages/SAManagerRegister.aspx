<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAManagerRegister.aspx.cs" Inherits="SportsWeb.RegisterPages.SAManagerRegister" %>
...
<body>
    <div id="bg"></div>    <form id="form1" runat="server">
        <h2>Register Sports Association Manager</h2>
        <table>
            <tr>
                <td>Name</td>
