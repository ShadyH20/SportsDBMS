    ...
    public partial class managematches : System.Web.UI.Page
    {
        ...
        protected void AddMatch_Click(object sender, EventArgs e)
        {
            ...
            if (res.Value.ToString() == "True")
            {
                ...
                conn.Close();
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Match added successfully!');", true);

            }
            else
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Enter Existing Clubs');", true);
        ...
        protected void deletematchbutton(object sender, EventArgs e)
        {
            ...
            if (res.Value.ToString() == "True")
            {
                ...
                addmatch.ExecuteNonQuery();
                conn.Close();
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Match deleted successfully!');", true);
