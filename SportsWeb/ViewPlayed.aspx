<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPlayed.aspx.cs" Inherits="SportsWeb.ViewPlayed" %>
...
<body>
    ...
    <form id="form2" runat="server">
        ...
        <table style="width: 397px; margin-left: 680px;">
            <asp:PlaceHolder ID="PlayedmatchesPH" runat="server"></asp:PlaceHolder>
            <tr>
                <td>
                    <br />
                </td>
