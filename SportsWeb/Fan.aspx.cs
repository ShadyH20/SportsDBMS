...
namespace SportsWeb
{
    public partial class Fan : System.Web.UI.Page
    {
        ...
        protected void availMatchesBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('There are no available matches at this time.');", true);
            }
        }
        ...
        protected void purchaseBtn_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Purchase Successful!');", true);
