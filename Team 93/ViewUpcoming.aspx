<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewUpcoming.aspx.cs" Inherits="SportsWeb.ViewUpcoming" %>
...
<body>
    ...
    <form id="form2" runat="server">
        ...
        <table style="width: 397px; margin-left: 680px;">
            <asp:PlaceHolder ID="matchesPH" runat="server"></asp:PlaceHolder>
            <tr>
                <td>
                    <br />
                </td>
